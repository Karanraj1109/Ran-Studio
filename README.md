...
Website layanan pembuatan website Ran Studio. Project ini menggunakan HTML, CSS, dan JavaScript tanpa build tool.

## Menjalankan lokal

Bisa dibuka langsung melalui `index.html`, atau gunakan server lokal:
